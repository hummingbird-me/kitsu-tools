...
(function() {
  var LibraryDropdown = React.createClass({displayName: 'LibraryDropdown',
  ...
  var LibraryEntry = React.createClass({displayName: 'LibraryEntry',
    getInitialState: function() {
    ...
    render: function() {
      ...
      if (content.get('rating')) {
        if (this.props.view.get('user.model.ratingType') == "advanced") {
          ...
          rating = (React.DOM.i( {className:iconClass} ));
        }
      }
      else {
        rating = (React.DOM.span(null, "—"));
      }
...
(function() {
  var MangaLibraryDropdown = React.createClass({displayName: 'MangaLibraryDropdown',
  ...
  var MangaLibraryEntry = React.createClass({displayName: 'MangaLibraryEntry',
    getInitialState: function() {
      return {dropdownOpen: false};
    },
