class NotNullColumns < ActiveRecord::Migration
  def change
    ...
    change_column :manga_library_entries, :chapters_read, :integer, null: false
    change_column :manga_library_entries, :volumes_read, :integer, null: false
    change_column :manga_library_entries, :reread_count, :integer, null: false
