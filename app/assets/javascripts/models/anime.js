Hummingbird.Anime = DS.Model.extend({
  ...
  searchString: function() {
    ...
    if (this.get('englishTitle') && this.get('englishTitle').length > 0) str += this.get('englishTitle');
    if (this.get('romajiTitle') && this.get('romajiTitle').length > 0) str += this.get('romajiTitle');
  ...
  airingStatus: function() {
    ...
    if (this.get('finishedAiring') && this.get('finishedAiring') < now) return "Finished Airing";
    else return "Currently Airing";
