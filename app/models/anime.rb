  ...
  def poster_image_thumb
    if self.poster_image_file_name.nil?
      ...
      if Rails.env.production?
        "http://static.hummingbird.me/anime/poster_images/#{"%03d" % (self.id/1000000 % 1000)}/#{"%03d" % (self.id/1000 % 1000)}/#{"%03d" % (self.id % 1000)}/large/#{self.poster_image_file_name.rpartition('.')[0]}.jpg?#{self.poster_image_updated_at.to_i}"
      else
